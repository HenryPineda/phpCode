            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/usuario/' . $usuario->id . '/edit') }}" title="Edit Usuario"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> =Nombre </th><td> {{ $usuario->=Nombre }} </td></tr><tr><th> Apellido </th><td> {{ $usuario->Apellido }} </td></tr><tr><th> Email </th><td> {{ $usuario->Email }} </td></tr>
                                </tbody>
                            </table>
                        </div>
